            ...
            load: function() {
                ...
                a.addFilter("publishHTML", function(b) {
					...
					if (c) {
						...
						b = b.replace(/<section class="display-7" style="padding: 0;align-items: center;justify-content: center;flex-wrap: wrap;    align-content: center;display: flex;position: relative;height: 4rem;">(.*?)<\/section>/img, '<section style="display: none;"><a href="https://mobiri.se"></a><a href="https://mobiri.se"></a></section>');
					}
